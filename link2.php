...
<div id="TableCodePreview" class="PreviewTable">
        <table>
            <thead>
                <tr>
               <td><label><input form="move" type="submit"  class="PreviewButton"  id="viewinfo" value="name" > </label></td>
               
				   <td><label><input form="move1" type="submit"  class="PreviewButton"  id="viewinfo" value="link1" > </a></label></td>
					<td><label><input form="move2" type="submit"  class="PreviewButton"  id="viewinfo" value="link2" ></a></label></td>
					<td><label><input form="move3" type="submit"  class="PreviewButton"  id="viewinfo" value="link3" ></a></label></td>
                </tr>
            </thead>
            <tbody>
